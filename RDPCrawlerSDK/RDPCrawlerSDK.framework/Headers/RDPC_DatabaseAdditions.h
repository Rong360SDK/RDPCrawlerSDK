...
@interface RDPC_Database (RDPC_DatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `RDPC_ResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (RDPC_ResultSet*)getSchema;
...
- (RDPC_ResultSet*)getTableSchema:(NSString*)tableName;
